									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="news_title_id" value="<?php echo $this->input->post('news_title_id'); ?>" class="form-control" id="news_title_id" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">Deskripsi Berita</label>
											<div class="form-group">
												<textarea name="news_desc_id" class="ckeditor form-control" id="profile"></textarea>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="lang-en">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="news_title_en" value="<?php echo $this->input->post('news_title_en'); ?>" class="form-control" id="news_title_en" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">News Description</label>
											<div class="form-group">
												<textarea name="news_desc_en" class="ckeditor form-control" id="profile"></textarea>
											</div>
										</div>
									</div>
								</div>
