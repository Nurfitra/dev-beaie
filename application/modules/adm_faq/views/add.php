	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">Tbl Product Add</h3>
			</div>
			<?php echo form_open('admin/faq/add'); ?>
			<div class="box-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="question_id" value="<?php echo $this->input->post('question_id'); ?>" class="form-control" id="question_id" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">Jawaban</label>
											<div class="form-group">
												<textarea name="answer_id" class="ckeditor form-control" id="profile"></textarea>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="lang-en">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="question_en" value="<?php echo $this->input->post('question_en'); ?>" class="form-control" id="question_en" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">Answer</label>
											<div class="form-group">
												<textarea name="answer_en" class="ckeditor form-control" id="profile"></textarea>
											</div>
										</div>
									</div>
								</div>
