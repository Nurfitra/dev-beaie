	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">Tbl Slider Add</h3>
			</div>
			<?php echo form_open_multipart('admin/home_slider/add'); ?>
			<div class="box-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="slider_title_id" value="<?php echo $this->input->post('slider_title_id'); ?>" class="form-control" id="slider_title_id" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">Deskripsi Slider</label>
											<div class="form-group">
												<input type="text" name="slider_desc_id" value="<?php echo $this->input->post('slider_desc_id'); ?>" class="form-control" id="slider_desc_id" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="lang-en">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="text" name="slider_title_en" value="<?php echo $this->input->post('slider_title_en'); ?>" class="form-control" id="slider_title_en" />
											</div>
										</div>
										<div class="col-md-12">
											<label for="profile" class="control-label">Slider Description</label>
											<div class="form-group">
												<input type="text" name="slider_desc_en" value="<?php echo $this->input->post('slider_desc_en'); ?>" class="form-control" id="slider_desc_en" />
											</div>
										</div>
									</div>
								</div>
